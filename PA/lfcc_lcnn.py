...
sys.path.insert(0, str(baseline_path / "project" / "baseline_PA"))
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: uv run python PA/lfcc_lcnn.py <audio_file_path>")
        print("Example: uv run python PA/lfcc_lcnn.py /home/audio/sample.wav")
        sys.exit(1)
