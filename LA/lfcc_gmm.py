...
baseline_path = Path(__file__).parent.parent / "ASVSpoof2021_baseline_system" / "LA" / "Baseline-LFCC-GMM" / "python"
...
if __name__ == "__main__":
    ...
    model_path = "LA/pretrained/LFCC_GMM.pkl"
